...
public class DocAsTestDocWiter extends DocWriter<com.github.docastest.test_tools.DocFormatter> {
    ...
    public DocAsTestDocWiter(boolean generateHtmlPage) {
        super(new com.github.docastest.test_tools.DocFormatter());
    ...
    private void generatePage(Class<?> clazz) {
        if (generateHtmlPage) {
            new com.github.docastest.test_tools.IntermediateHtmlPage().generate(clazz);
        }
    }
}
