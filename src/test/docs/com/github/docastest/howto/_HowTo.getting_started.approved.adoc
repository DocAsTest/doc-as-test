...
[#com_github_docastest_howto_howto_getting_started]
= Getting started
...
You can alo follow steps of the link:{ROOT_PATH}/com/github/docastest/howto/Tutorial.html[Get started] page.
...
* link:{ROOT_PATH}/com/github/docastest/howto/InstallingLibrary.html[Installing DocumentationTesting] maven library and add dependency to your `pom.xml`
