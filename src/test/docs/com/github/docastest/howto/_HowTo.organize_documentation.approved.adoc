...
[#com_github_docastest_howto_howto_organize_documentation]
...
We can use subclasses to create subchapter in the document (see: link:{ROOT_PATH}/com/github/docastest/doctesting/junitextension/ApprovalsExtensionTest.html#com_github_docastest_doctesting_junitextension_approvalsextensiontest_nested_class[Nested class])
