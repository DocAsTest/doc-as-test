...
[#com_github_docastest_codeextraction_codeextractortest_extractcomment_bug_when_annotation_before_comment]
...
[source, java, indent=0]
----
include::../../../../../java/com/github/docastest/codeextraction/ClassWithAnnotationBeforeComment.java[tag=ClassWithAnnotationBeforeComment]
----
