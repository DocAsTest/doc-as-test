...
[#com_github_docastest_codeextraction_codeextractortest]
= CodeExtractor
...
[#com_github_docastest_codeextraction_codeextractortest_extractcode]
== Extract code
...
[#com_github_docastest_codeextraction_codeextractortest_extractcode_extractpartofcode]
...
[#com_github_docastest_codeextraction_codeextractortest_extractcomment]
== Extract comment
...
[#com_github_docastest_codeextraction_codeextractortest_extractcodeandresult]
