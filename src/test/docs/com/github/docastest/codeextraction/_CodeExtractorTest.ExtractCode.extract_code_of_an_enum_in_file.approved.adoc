...
[#com_github_docastest_codeextraction_codeextractortest_extractcode_extract_code_of_an_enum_in_file]
...
[source, java, indent=0]
----
include::../../../../../java/com/github/docastest/codeextraction/CodeExtractorTest.java[tag=EnumNotInAClass]
----
====
...
[source, java, indent=0]
----
include::../../../../../java/com/github/docastest/codeextraction/CodeExtractorTest.java[tag=ClassWithEnum]
----
====
