...
[#com_github_docastest_codeextraction_parsedclassrepositorytest_create_parsedclassrepository]
...
++++
<style>
#com_github_docastest_codeextraction_parsedclassrepositorytest_create_parsedclassrepository ~ .inline {
