...
[#com_github_docastest_codeextraction_parsedclassrepositorytest]
...
[#com_github_docastest_codeextraction_parsedclassrepositorytest_retrievecomment]
== Retrieve comment
...
[#com_github_docastest_codeextraction_parsedclassrepositorytest_retrievelinenumber]
