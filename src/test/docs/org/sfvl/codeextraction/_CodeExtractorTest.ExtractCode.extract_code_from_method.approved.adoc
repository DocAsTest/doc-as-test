...
[#com_github_docastest_codeextraction_codeextractortest_extractcode_extract_code_from_method]
...
[source, java, indent=0]
----
include::../../../../../java/com/github/docastest/doctesting/sample/ClassWithNestedClass.java[tag=ClassWithNestedClass]
----
====
