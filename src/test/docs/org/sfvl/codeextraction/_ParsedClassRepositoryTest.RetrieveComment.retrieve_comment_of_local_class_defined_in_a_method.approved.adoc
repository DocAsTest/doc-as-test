...
[#com_github_docastest_codeextraction_parsedclassrepositorytest_retrievecomment_retrieve_comment_of_local_class_defined_in_a_method]
...
++++
<style>
#com_github_docastest_codeextraction_parsedclassrepositorytest_retrievecomment_retrieve_comment_of_local_class_defined_in_a_method ~ .inline {
