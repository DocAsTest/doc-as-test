...
[#com_github_docastest_codeextraction_codeextractortest_extractcode_extract_code_of_an_inner_class]
...
[source, java, indent=0]
----
include::../../../../../java/com/github/docastest/codeextraction/CodeExtractorTest.java[tag=SimpleInnerClass]
----
====
