...
[#com_github_docastest_codeextraction_codeextractortest_extractcomment_extract_class_comment]
...
[source, java, indent=0]
----
include::../../../../../java/com/github/docastest/doctesting/sample/ClassWithCommentToExtract.java[tag=ClassWithCommentToExtract]
----
...
[source, java, indent=0]
----
include::../../../../../java/com/github/docastest/codeextraction/CodeExtractorTest.java[tag=NestedClass]
----
...
[source, java, indent=0]
----
include::../../../../../java/com/github/docastest/codeextraction/CodeExtractorTest.java[tag=classNestedWithCommentToExtract]
----
