...
[#com_github_docastest_doctesting_writer_classdocumentationtest_nested_class_documentation]
...
[source, java, indent=0]
----
include::../../../../../../../../src/test/java/com/github/docastest/doctesting/writer/ClassDocumentationTest.java[tag=ClassDocumentationTest_DemoNestedTest]
----
