...
[#com_github_docastest_doctesting_writer_classdocumentationtest_demonestedtest]
= Class documentation test_ demo nested test

Demo of a simple usage to generate documentation.

[#com_github_docastest_doctesting_writer_classdocumentationtest_demonestedtest_adding]
== Adding
...
[#com_github_docastest_doctesting_writer_classdocumentationtest_demonestedtest_adding_addingnegativenumber]
...
[#com_github_docastest_doctesting_writer_classdocumentationtest_demonestedtest_multiply]
== Multiply
