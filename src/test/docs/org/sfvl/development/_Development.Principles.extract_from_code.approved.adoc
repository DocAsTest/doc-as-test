...
[#com_github_docastest_development_development_principles_extract_from_code]
= Extract from code
...
For more detail to get method name with reference, see: link:{ROOT_PATH}/com/github/docastest/codeextraction/CodeExtractionPackage.html[MethodReference documentation]
