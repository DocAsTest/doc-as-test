...
public class Options {
    ...
    public com.github.docastest.doctesting.writer.Options with(String key, String value) {
        options.add(new Option(key, value));
        return this;
    }

    public com.github.docastest.doctesting.writer.Options with(String key) {
        options.add(new Option(key));
        return this;
    }

    public com.github.docastest.doctesting.writer.Options remove(String key) {
